...
import (
	...
	"github.com/mustafaakin/kubernetes-event-exporter/pkg/exporter"
	"github.com/mustafaakin/kubernetes-event-exporter/pkg/kube"
	"github.com/mustafaakin/kubernetes-event-exporter/pkg/metrics"
	"github.com/mustafaakin/kubernetes-event-exporter/pkg/setup"
...
func main() {
	...
	w := kube.NewEventWatcher(kubecfg, cfg.Namespace, cfg.MaxEventAgeSeconds, metricsStore, onEvent, cfg.OmitLookup, cfg.CacheSize, cfg.ReportUpdates)
